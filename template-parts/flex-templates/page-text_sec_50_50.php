<?php 
/**
 * Renders Half anf Half text sections
 */
...
$optional_heading = get_sub_field('optional_heading');
...
<section class="sixty-forty-section <?php echo $text_sec_bg_class; ?>" <?php if ($anchor) echo "id=$anchor" ?>>
